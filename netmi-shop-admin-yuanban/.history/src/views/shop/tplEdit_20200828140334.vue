            ...
            <div v-if="item.type==21" class="tpl-item-box1">
              <div class="item-box-item">
                <div style="display: flex;">
                  <div style="width:80px" v-for="(item2,index2) in item.moduleList" :key="index2">{{item2.name}}&nbsp;&nbsp;&nbsp;</div>
                </div>
              </div>
            </div>
              ...
              <div class="edit-panel">
                ...
                <div style="max-height: 610px;overflow-y: auto;">
                  ...
                  <div v-if="item.type==21">
                    <div v-for="(item2,index2) in item.moduleList" :key="index2">
                      <div>
                        <span>分类标题</span>
    ...
    selectClass2(item) {
      ...
      if (this.select_type === '1') {
        ...
        if(self.iscoryShow) {
          ...
          self.content.list[this.cory_index].origList[this.cory_index1].param=item.mcid

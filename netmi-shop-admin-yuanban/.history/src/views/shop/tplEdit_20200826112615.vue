                ...
                <div style="max-height: 610px;overflow-y: auto;">
                  ...
                  <div v-if="item.type==21">
                    ...
                    <div style="padding:20px">
                      <div style="padding:20px 0" v-for="(item2,index2) in item.origList" :key="index2">{{item2.name}}&nbsp;&nbsp;&nbsp;<el-button type="danger" icon="el-icon-delete" size="mini" circle @click="del"></el-button> </div>
                    </div>
                    <!-- &nbsp;&nbsp;&nbsp;
                    <div style="width:150px">

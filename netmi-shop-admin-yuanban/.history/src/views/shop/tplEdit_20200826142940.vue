                  ...
                  <div v-if="item.type==21">
                    ...
                    <div style="padding:20px 0">
                      <el-tag
                        ...
                        :key="tag.name"
                        closable
                        @close="delClassItem(index,tag.mcid)">
                        {{tag.name}}
                      </el-tag>
  ...
  methods: {
    ...
    */
    ...
    delClassItem(index,index1) {
      // console.log(index,index1)
      for(let i=0;i<this.content.list[index].origList.length;i++){
        if(this.content.list[index].origList[i].mcid==index1) {
          this.content.list[index].origList.splice(i,1)
        }
      }
      // console.log(this.content.list[index].origList)
    },

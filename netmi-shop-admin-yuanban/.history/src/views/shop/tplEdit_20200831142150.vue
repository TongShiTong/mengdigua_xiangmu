                      ...
                      <div class="item-content">
                        ...
                        <div class="data-box">
                          ...
                          <el-row style="line-height:34px;">
                            ...
                            <el-select v-if="item.type!=18||item2.kind==1" v-model="item2.type" style="width:160px;" size="mini" placeholder="打开页面" @change="changeItem(index,index3,index2)">
...
export default {
  ...
  methods: {
    ...
    changeItem(index, index1, index2) {
     ...
     changeItem1(index, index1, index2) {
      // console.log(index, index1, index2)
      this.content.list[index].moduleList[index1].image_data[index2].param = ''
      this.content.list[index].moduleList[index1].image_data[index2].title = ''

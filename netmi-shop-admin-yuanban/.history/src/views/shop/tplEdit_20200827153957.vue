        ...
        <el-col v-show="!activeFlag" :span="5" style="min-height:100px">
          <div v-if="class2.length>0" >
            <el-menu
              ...
              class="el-menu-vertical-demo"
            >
              <el-menu-item v-for="(item1,index1) in class2" :index="index1+''" :key="index1" style="padding:0 5px;height: 42px;line-height: 42px;" @click="selectClass2(item1,index)">

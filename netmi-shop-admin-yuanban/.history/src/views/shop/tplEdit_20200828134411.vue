              ...
              <div class="edit-panel">
                ...
                <div v-if="item.type==22">
                  <div v-if="item.shop_title!=undefined">
                    ...
                    <el-button @click="chooseMukuai1(index,3)" type="primary" round style="margin-left: 10px;" >添加店铺</el-button>
                  </div>
                </div>
                ...
                <div style="max-height: 610px;overflow-y: auto;">
                  ...
                  <div v-if="item.type==21">
                    <div v-for="(item2,index2) in item.origList" :key="index2">
                      <el-input v-model="item2.shop_title" style="width:200px;" size="mini" placeholder="显示标题"/>
                  ...
                  <div v-if="item.type==22">
                    ...
                    <!-- <el-row style="line-height:32px;display:flex;" v-if="item.shop_title!=undefined">
                      <span style="padding-right:4px;">模块标题：</span>
                      <el-input v-model="item.shop_title" style="width:350px;" size="mini" placeholder="模块标题" />
                    </el-row> -->
                    ...
                    <div v-for="(item3,index3) in item.moduleList" :key="index3+'i'" style="border:1px solid #ddd;padding: 10px;margin: 10px 0;position: relative;">
                      ...
                      <el-button v-if="item3.type==3" @click="deletaMokuia(index,index3)" type="danger" round style="position: absolute;right:10px;bottom:8px;z-index: 11;">删除店铺{{index3+1}}</el-button>
                    </div>
                  </div>

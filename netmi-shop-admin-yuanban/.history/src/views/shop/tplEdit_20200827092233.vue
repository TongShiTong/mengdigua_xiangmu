  ...
  <div class="index-tpl">
            ...
            <el-popover
              ...
              <div class="edit-panel">
                ...
                <div style="max-height: 610px;overflow-y: auto;">
                  ...
                  <div v-if="item.type!=1&&item.type!=6&&item.type!=7&&item.type!=8&&item.type!=9&&item.type!=10&&item.type!=17&&item.type!=11&&item.type!=12&&item.type!=13&&item.type!=14&&item.type!=15&&item.type!=16&&item.type!=19&&item.type!=21" class="two-row">
    ...
    <div class="f-tools">
      <div class="tool-box">
        ...
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(21)">店铺列表</el-button>
        </div>
        <div class="tool-item">

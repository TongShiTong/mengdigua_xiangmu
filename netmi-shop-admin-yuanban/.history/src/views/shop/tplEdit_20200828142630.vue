            ...
            <div v-if="item.type==21" class="tpl-item-box1">
              <div class="item-box-item">
                <div style="display: flex;">
                  <div style="width:80px;border-right:1px solid #ccc" v-for="(item2,index2) in item.moduleList" :key="index2">{{item2.name}}&nbsp;&nbsp;&nbsp;</div>
                </div>
              </div>
            </div>
              ...
              <div class="edit-panel">
                ...
                <div v-if="item.type==6||item.type==7||item.type==8||item.type==9||item.type==10||item.type==17||item.type==19||item.type==12||item.type==13||item.type==14||item.type==15||item.type==16" class="two-row">
                 ...
                 <div v-if="item.type==21" style="text-align: center;">
                  <el-button @click="chooseMukuaifl(index)" type="primary" round style="margin-left: 10px;" >添加分类</el-button>
                </div>
                ...
                <div style="max-height: 610px;overflow-y: auto;">
                  ...
                  <div v-if="item.type==21">
                    <div v-for="(item2,index2) in item.moduleList" :key="index2" style="padding: 20px;position: relative;">
                      <div>
                        <span>分类标题</span>
                      ...
                      <div>
                        ...
                        <el-button type="primary" @click="addCory(index,index2)" size="medium" icon="el-icon-search" circle></el-button>
                        <span style="color:red;">（* 选择分类导航栏参数）</span>
                        <el-button type="danger" icon="el-icon-delete" circle @click="delClassItem(index,index2)" size="medium" style="position: absolute;right: 10px;"></el-button>
                      </div>
                    </div>
...
<!--                     
                    <div style="padding:20px 0">
                      <el-tag
                        style="margin:5px"
                        v-for="(tag,index2) in item.moduleList"
                        :key="index2"
                        closable

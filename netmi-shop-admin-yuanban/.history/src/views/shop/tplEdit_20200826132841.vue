                ...
                <div style="max-height: 610px;overflow-y: auto;">
                  ...
                  <div v-if="item.type==21">
                    <div style="width:150px">
                      <el-select v-model="class_name" placeholder="请选择分类" @change="allSelectOne1">
                        <el-option
...
export default {
  ...
  data() {
    return {
      ...
      classList: [],//分类列表
      class_name:'',
      list_index: 0,//点击右侧导航栏时content.list的下标
      class1: [],
      class1_act: '',
      class2: [],
      class2_act: '',
  ...
  methods: {
   ...
   setBgcolor() {
    ...
    addTpl(type) {
      ...
      self.list_index = self.content.list.length - 1
    ...
    */
    ...
    allSelectOne1(id) {
      console.log(123,this.list_index)
      console.log(111,id)
      for(let i=0;i<this.classList.length;i++) {
        if(this.classList[i].mcid==id){
          this.content.list[this.list_index].origList.push(this.classList[i])
        }
      }
      this.class_name = ''
      console.log(this.content.list[this.list_index].origList)
    },
    // 删除分类

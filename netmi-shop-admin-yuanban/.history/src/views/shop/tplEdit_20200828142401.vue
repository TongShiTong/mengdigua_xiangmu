              ...
              <div class="edit-panel">
                ...
                <div style="max-height: 610px;overflow-y: auto;">
                  ...
                  <div v-if="item.type==21">
                    <div v-for="(item2,index2) in item.moduleList" :key="index2" style="padding: 20px;">
                      <div>
                        <span>分类标题</span>
                      ...
                      <div>
                        ...
                        <el-button type="danger" icon="el-icon-delete" circle @click="daletCory(index,index2)" size="medium" icon="el-icon-search" circle></el-button>
                      </div>
                    </div>

                        ...
                        <div v-for="(item2,index2) in item3.image_data" :key="index2+'a'" class="two-row-item">
                          ...
                          <div class="item-content">
                            ...
                            <div class="data-box">
                              ...
                              <el-row style="line-height:34px;">
                                <span style="font-size:12px;">打开页面：</span>
                                <el-select v-model="item2.type" style="width:160px;" size="mini" placeholder="打开页面" @change="changeItem(item2.type,index,index3,index2)">
                                  <el-option label="无" value="0"/>
                                  <el-option label="商品" value="1"/>
                                  <!-- <el-option v-if="tplInfo.shop_id==0" label="礼包商品" value="15"/> -->
                                  <el-option label="装修页" value="9"/>
                      ...
                      <div class="two-row"> -->
                        <div v-for="(item4,index4) in item3.floor_data" :key="index4" class="two-row-item">
                          ...
                          <div class="data-box">
                              ...
                              <el-row style="line-height:34px;">
                                <span style="font-size:12px;">打开页面：</span>
                                <el-select v-model="item4.type" style="width:160px;" size="mini" placeholder="打开页面" @change="changeItem(item4.type,index,index3,index4)">
                                  <el-option label="无" value="0"/>
                                  <el-option label="商品" value="1"/>
                                  <!-- <el-option v-if="tplInfo.shop_id==0" label="礼包商品" value="15"/> -->
                                  <el-option label="装修页" value="9"/>
...
export default {
  ...
  methods: {
    ...
    changeItem(type, index, index1, index2) {
      console.log(147,type, index, index1, index2)
      this.content.list[index].moduleList[index1].image_data[index2].param = item.mcid
    },
    goBack() {
      this.$router.go(-1)
    },

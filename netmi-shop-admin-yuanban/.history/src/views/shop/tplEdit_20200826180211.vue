  ...
  <div class="index-tpl">
            ...
            <el-popover
              ...
              <div class="edit-panel">
                ...
                <div class="one-row" style="position: relative;">
                  ...
                  <div v-if="item.bgurl||item.bgcolor" style="flex:none;position: absolute;top: 40px;left: 230px;">
                    <el-button type="info" size="mini" plain @click="clearBgImg1(index)">取消背景图</el-button>
                  </div>
                  <div class="row-col" style="flex:none">
                    <div class="col-label">
                      阴影
    ...
    <div class="qunju-bg" v-if="isSetBg">
      ...
      <div class="edit-panel">
        ...
        <div v-if="content.bg_img">
          <el-button type="info" size="mini" plain @click="clearBgImg(index)">取消背景图</el-button>
        </div>
      </div>
    </div>
    <div class="f-tools">

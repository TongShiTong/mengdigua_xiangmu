  ...
  <div class="index-tpl">
                ...
                <div style="max-height: 610px;overflow-y: auto;">
                  ...
                  <div v-if="item.type==21">
                    <div>
                      ...
                      <el-button type="primary" @click="addCory(index)">选择商品分类</el-button>
    ...
    <div class="f-tools">
      <div class="tool-box">
        ...
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(22)">店铺列表1</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(22)">店铺列表2</el-button>
        </div>
        <div class="tool-item">
          <el-button type="primary" style="width:100px;" size="mini" icon="el-icon-plus" @click="addTpl(22,)">店铺列表3</el-button>
        </div>
        <div class="tool-item">
   ...
   setBgcolor() {
    ...
    addTpl(type,type1) {
      ...
      if (type === 1) {
        ...
        chooseMukuai1(self.content.list.length - 1,type1)
      }
            ...
            for(let m=0;m<list.list[i].moduleList.length;m++) {
              if(list.list[i].moduleList[m].image_data) {
                for(let n=0;n<list.list[i].moduleList[m].image_data.length;n++) {
                  list.list[i].moduleList[m].image_data[n].good_info = {title:''}
                }
                
              }
              if(list.list[i].moduleList[m].floor_data) {
                for(let n=0;n<list.list[i].moduleList[m].floor_data.length;n++) {
                  list.list[i].moduleList[m].floor_data[n].good_info = {title:''}
                }
    ...
    selectClass2(item) {
      ...
      if (this.select_type === '1') {
        ...
        if(self.iscoryShow) {
          ...
          self.content.list[this.cory_index].origList.push(item)

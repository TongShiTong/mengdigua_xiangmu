  ...
  <div class="index-tpl">
      ...
      <draggable
        ...
        <div v-for="(item,index) in content.list" :style="{marginTop:item.top+'px',marginBottom:item.bottom+'px',paddingLeft:item.left+'px',paddingRight:item.right+'px', backgroundColor:item.bgcolor,backgroundImage: 'url('+ item.bgurl +')',backgroundSize:'cover',backgroundRepeat: 'no-repeat', borderRadius:item.borderRadius+'px'}" :key="index" class="tpl-item">
          <div class="tpl-item-box">
            <div v-if="item.type!=2&&item.type!=4&&item.type!=10&&item.type!=17&&item.type!=19&&item.type!=20" class="tpl-item-box1">
              <div v-for="(item1,index1) in item.floor_data" :key="index1" class="item-box-item">
                <img v-if="item1.img_url" :src="item1.img_url">
                <div v-if="!item1.img_url&&item.type!=1&&item.type!=3&&item.type!=6&&item.type!=7&&item.type!=8&&item.type!=9&&item.type!=10&&item.type!=11&&item.type!=12&&item.type!=13&&item.type!=14&&item.type!=15&&item.type!=16&&item.type!=17&&item.type!=19" class="no-img">
                  未配置
                </div>
            ...
            <div v-if="item.type==10||item.type==17||item.type==19" class="tpl-item-box1">
              <div class="item-box-item">
                ...
                <div v-if="item.type==19" class="no-img vae">
                  <span>通用商品列表</span>
                </div>
              </div>
            </div>
              ...
              <div class="edit-panel">
                ...
                <div class="one-row" style="position: relative;">
                  <div class="row-col" style="flex:none">
                    ...
                    <div>
                      <el-input-number v-model="item.borderRadius" :min="0" :max="20" style="width:110px;" size="mini" label="顶部间隙"/>
                    </div>
                  </div>
                  <div class="row-col" style="flex:none">
                    <div class="col-label">
                  ...
                  <div class="row-col" style="flex:none;position: absolute;top: 40px;">
                    <div class="col-label">
                      显示
                    </div>
                    <div>
                ...
                <div v-if="item.type==6||item.type==7||item.type==8||item.type==9||item.type==10||item.type==17||item.type==19||item.type==12||item.type==13||item.type==14||item.type==15||item.type==16" class="two-row">
                  <el-row style="line-height:32px;display:flex;">
                    <span v-if="item.type!=10&&item.type!=17&&item.type!=19" style="padding-right:15px;">显示个数</span>
                    <el-select v-if="item.type!=10&&item.type!=17&&item.type!=19" v-model="item.nums" style="width:110px;padding-right:15px;" size="mini" placeholder="显示个数" @change="setNums(index,item.type)">
                    ...
                    <el-button @click="addTab(index)" type="primary" round style="margin-left: 10px;" v-if="item.type==19&&item.moduleList.length<4">添加tab栏</el-button>
                  </el-row>
                </div>

                <div style="max-height: 610px;overflow-y: auto;">
                <!-- 公告里面设置显示几项 -->
                  <div v-if="item.type==3" class="two-row" style="margin-bottom:10px">
                    <span>选择模块：</span>
                  ...
                  <div v-if="item.type!=1&&item.type!=6&&item.type!=7&&item.type!=8&&item.type!=9&&item.type!=10&&item.type!=17&&item.type!=11&&item.type!=12&&item.type!=13&&item.type!=14&&item.type!=15&&item.type!=16&&item.type!=19" class="two-row">
                      ...
                      <div class="item-content">
                        ...
                        <div class="data-box">
                          ...
                          <el-row style="line-height:34px;">
                            ...
                            <el-select v-if="item.type!=18||item2.kind==1" v-model="item2.type" style="width:160px;" size="mini" placeholder="打开页面">
                  ...
                  <div v-if="item.type==19">
                    ...
                    <div v-for="(item3,index3) in item.moduleList" :key="index3" style="border:1px solid #ddd;padding: 10px;margin: 10px 0;position: relative;">
                      ...
                      <el-button @click="deletaMokuia(index,index3)" type="danger" round style="position: absolute;right:10px;bottom:8px">删除模块{{item3.type}}</el-button>
                    </div>
                  </div>
                  ...
                  <div v-if="item.type==3">
                    <div v-for="(item3,index3) in item.moduleList" :key="index3" style="border:1px solid #ddd;padding: 10px;margin: 10px 0;position: relative;">
                      <div v-if="item3.group_data">
                        <div v-for="(item5,index5) in item3.group_data" :key="index5">
                          <el-row style="line-height:32px;display:flex;">
                            <span style="padding-right:4px;">模块标题：</span>
                            <el-input v-model="item5.title" style="width:350px;" size="mini" placeholder="模块标题" />
                          </el-row>
                          <el-row style="line-height:32px;display:flex;">
                            <span style="padding-right:4px;">标题简介：</span>
                            <el-input v-model="item5.content" style="width:350px;" size="mini" placeholder="标题简介" />
                          </el-row>
                          ...
                          <el-row v-if="item5.isprogress" style="line-height:32px;display:flex;">
                            <span>是否显示进度条：</span>
                            <el-select v-model="item5.hasprogress" style="width:110px;padding-right:15px;" size="mini">
                              <el-option :key="0" :label="'否'" :value="0"/>
                              <el-option :key="1" :label="'是'" :value="1"/>
                            </el-select>
                          </el-row>
                          
                          <div class="two-row" v-if="item5.hasfloor_data">
                            <div v-for="(item4,index4) in item5.floor_data" :key="index4" class="two-row-item">
                              <div class="item-btns">
                                <el-row>
                                  <el-button style="margin-bottom:5px;" icon="el-icon-arrow-down" size="mini" circle @click="downImg4(index,index3,index4,index5)"/>
                                  <el-button style="margin-bottom:5px;" icon="el-icon-arrow-up" size="mini" circle @click="upImg4(index,index3,index4,index5)"/>
                                  <el-button type="danger" icon="el-icon-delete" size="mini" circle @click="delImg4(index,index3,index4,index5)"/>
                                </el-row>
                              </div>
                              <div class="item-content">
                                <div class="img-box">
                              ...
                              <div class="data-box">
                                  ...
                                  <el-row style="line-height:32px;display:flex;">
                                    <span style="padding-right:4px;font-size:12px;">页面参数：</span>
                                    <el-input v-model="item4.param" :disabled="item4.type==1||item4.type==2||item4.type==3" style="width:300px;" size="mini" class="input-with-select">
                                      <el-button slot="append" size="mini" icon="el-icon-search" @click="selectItem4(item4.type,index,index3,index4,index5)"/>
                                    </el-input>
                                    <span v-if="item4.type==0" style="color:red;">(不必填)</span>
                                    <span v-if="item4.type==1" style="color:red;">(商品id)</span>
                                    <span v-if="item4.type==2" style="color:red;">(商品分类id)</span>
                            ...
                            <!-- 配置自定义商品的蓝色按钮 ↓ v-if="item.floor_data.length<11"-->
                            <div style="line-height:32px;text-align:center;">
                              <el-button type="primary" icon="el-icon-plus" size="mini" circle @click="addImg4(index,index3,item.type,index5)"/>
                            </div>
                          </div>
                          ...
                          <div class="two-row" v-if="item5.hasimage_data">
                            <div v-for="(item2,index2) in item5.image_data" :key="index2" class="two-row-item">
                              <div class="item-btns">
                                <el-row>
                                  <el-button style="margin-bottom:5px;" icon="el-icon-arrow-down" size="mini" circle @click="downImg3(index,index3,index2,index5)"/>
                                  <el-button style="margin-bottom:5px;" icon="el-icon-arrow-up" size="mini" circle @click="upImg3(index,index3,index2,index5)"/>
                                  <el-button  type="danger" icon="el-icon-delete" size="mini" circle @click="delImg3(index,index3,index2,index5)"/>
                                </el-row>
                              </div>
                              <div class="item-content">
                                <div class="img-box" @click="setIndex3(index,index3,index2,index5)">
                                  <el-upload
                                    :data="{index:index,index3:index3,index2:index2,index5:index5}"
                                    :show-file-list="false"
                                    :on-success="handleGgSuccess11"
                                    :before-upload="beforeAvatarUpload"
                                    :action="base_api+'/material/index/upload'"
                                    class="avatar-uploader">
                                    <div v-if="item2.img_url" :style="{backgroundImage: 'url('+ item2.img_url +')'}" class="avatar"/>
                                ...
                                <div class="data-box">
                                  ...
                                  <el-row style="line-height:32px;display:flex;">
                                    <span style="padding-right:4px;font-size:12px;">页面参数：</span>
                                    <el-input v-model="item2.param" :disabled="item2.type==1||item2.type==2||item2.type==3" style="width:300px;" size="mini" class="input-with-select">
                                      <el-button slot="append" size="mini" icon="el-icon-search" @click="selectItem3(item2.type,index,index3,index2,index5)"/>
                                    </el-input>
                                    <span v-if="item2.type==0" style="color:red;">(不必填)</span>
                                    <span v-if="item2.type==1" style="color:red;">(商品id)</span>
                                    <span v-if="item2.type==2" style="color:red;">(商品分类id)</span>
                            ...
                            <div style="line-height:32px;text-align:center;">
                              <el-button  type="primary" icon="el-icon-plus" size="mini" circle @click="addImg3(index,index3,item.type,index5)"/>
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    <div class="qunju-bg" v-if="isSetBg">
      ...
      <div class="edit-panel">
        ...
        <div v-if="content.bg_img || content.bg_color">
          <el-button type="info" size="mini" plain @click="clearBgImg()">取消背景</el-button>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    selectItem(type, index, index1) {
      ...
      if (type === '1' || type === '2') { // 打开商品选择页面
        ...
        this.select_index2 = ''
        this.select_index3 = ''
        this.select_spindex2 = ''
        this.select_spindex3 = ''
    ...
    selectItem3(type, index, index1, index2,index3) {
      console.log(type, index, index1, index2,index3)
      if (type === '1') { // 打开商品选择页面
        this.select_type = type
        this.select_index = index
        this.select_index1 = index1
        this.select_index2 = index2
        this.select_index3 = index3
        this.dialogTableVisible = true
        this.getGift()
      } else if (type === '3') {
        this.select_type = type
    ...
    selectItem4(type, index, index1, index2,index3) {
      console.log(147,type, index, index1, index2,index3)
      if (type === '1') { // 打开商品选择页面
        this.select_sptype = type
        this.select_spindex = index
        this.select_spindex1 = index1
        this.select_spindex2 = index2
        this.select_spindex3 = index3
        this.dialogTableVisible = true
        this.getGift()
      } else if (type === '3') {
        this.select_sptype = type
    ...
    */
    ...
    setIndex3(index,index1,index2,index3) {
      console.log(index,index1,index2,index3)
      const self = this
      self.ggImage_url = index
      self.image_url_index = index1
      self.ggImage_url_index = index2
      self.image_url_index1 = index3
    },
    ...
    */
    ...
    handleGgSuccess11(res, file) {
      const self = this
      var image = new Image()
      image.src = res.data.url
      image.onload = function() {
        self.content.list[self.ggImage_url].moduleList[self.image_url_index].group_data[self.image_url_index1].image_data[self.ggImage_url_index].img_width = image.width
        self.content.list[self.ggImage_url].moduleList[self.image_url_index].group_data[self.image_url_index1].image_data[self.ggImage_url_index].img_height = image.height
      }
      self.content.list[self.ggImage_url].moduleList[self.image_url_index].group_data[self.image_url_index1].image_data[self.ggImage_url_index].img_url = res.data.url
    }, 
    ...
    */
    ...
    delImg4(index, index1,index2,index3) {
      const self = this
      self.content.list[index].moduleList[index1].group_data[index3].floor_data.splice(index2, 1)

      self.content.list[index].moduleList[index1].group_data[index3].goods_list = []
      for (let i = 0; i < self.content.list[index].moduleList[index1].group_data[index3].floor_data.length; i++) {
        self.content.list[index].moduleList[index1].group_data[index3].goods_list.push(self.content.list[index].moduleList[index1].group_data[index3].floor_data[i].good_info.item_id)
      }
    },
    ...
    delImg3(index, index1,index2,index3) {
      const self = this
      self.content.list[index].moduleList[index1].group_data[index3].image_data.splice(index2, 1)

      self.content.list[index].moduleList[index1].group_data[index3].goods_list = []
      for (let i = 0; i < self.content.list[index].moduleList[index1].group_data[index3].image_data.length; i++) {
        self.content.list[index].moduleList[index1].group_data[index3].goods_list.push(self.content.list[index].moduleList[index1].group_data[index3].image_data[i].good_info.item_id)
      }
    },
    /**
     * 添加图片
    ...
    */
    ...
    addImg4(index,index1, t,index3) {
      ...
      if (t != 3&&t != 19) {
        ...
        self.content.list[index].moduleList[index1].group_data[index3].floor_data.push(obj)
      } else { // 这是自定义商品
        this.theIndex = index
        this.theIndex1 = index1 // 公告里面的选中的商品
        this.theIndex2 = index3 // 公告里面的选中的商品
        console.log(this.theIndex1)
        this.dialogTableVisible4 = true
        this.getAllGoods()
      }
    ...
    addImg3(index,index1, t,index2) {
      console.log(index,index1,t,index2)
      ...
      self.content.list[index].moduleList[index1].group_data[index2].image_data.push(obj)
    ...
    AllsureDelete(item) {
      ...
      if(self.theIndex1==="") {
        ...
        if(self.theIndex2==="") {
          ...
          self.content.list[self.theIndex].moduleList[self.theIndex1].group_data[self.theIndex2].floor_data.forEach(function(v, i, a) {
            if (v.param == item.item_id) {
              self.content.list[self.theIndex].moduleList[self.theIndex1].group_data[self.theIndex2].floor_data.splice(i, 1)
            }
          })
        }  
      }   
    ...
    markItem() { // 根据all_idList给被选好的数据进行标记  还要根据已经被选好存在的 丧心病狂
      ...
      // console.log('已经存在的自定义商品1', self.content.list[self.theIndex].moduleList[self.theIndex1].floor_data)
      if(self.theIndex1==="") {
        ...
        if(self.theIndex2==="") {
          ...
          self.content.list[self.theIndex].moduleList[self.theIndex1].group_data[self.theIndex2].floor_data.forEach(function(val, item, index) {
            self.all_showList.forEach(function(v, i, a) {
              if (val.param == v.item_id) { // 被展示的该商品是被选中的
                self.$set(self.all_showList[i], 'select', 1)
              }
    ...
    SaveAllGoods() {
      ...
      const obj = {
        ...
        img_width: 0, // 显示宽度
        img_height: 0, // 显示高度
        type: "无", // 点击效果类型 ——  商品：1，分类对应列表：2，店铺：3，热门商品列表：4，新品推荐列表：5，推荐店铺列表：6，富文本：7，外链：8，
        param: '', // 点击效果对应参数
        imgtit: ''
      }
      ...
      if(self.theIndex1==="") {
        ...
        if(self.theIndex2==="") {
          ...
          arr1.forEach(function(v, i, a) {
            self.content.list[self.theIndex].moduleList[self.theIndex1].group_data[self.theIndex2].floor_data.push(v)
          })
          for (let i = 0; i < arr1.length; i++) {
            self.content.list[self.theIndex].moduleList[self.theIndex1].group_data[self.theIndex2].goods_list.push(arr1[i].good_info.item_id)
          }
        }
    ...
    */
    ...
    downImg1(index, index1,index2) {
     ...
     downImg4(index, index1,index2,index3) {
      console.log(index, index1,index2,index3)
      const self = this
      if (index2 === (self.content.list[index].moduleList[index1].group_data[index3].floor_data.length - 1)) {
        return
      }
      const obj = self.content.list[index].moduleList[index1].group_data[index3].floor_data[index2]
      const obj1 = self.content.list[index].moduleList[index1].group_data[index3].floor_data[index2 + 1]
      self.$set(self.content.list[index].moduleList[index1].group_data[index3].floor_data, index2, obj1)
      self.$set(self.content.list[index].moduleList[index1].group_data[index3].floor_data, (index2 + 1), obj)

      const dd1 = self.content.list[index].moduleList[index1].group_data[index3].goods_list[index2]
      const dd2 = self.content.list[index].moduleList[index1].group_data[index3].goods_list[index2 + 1]
      self.$set(self.content.list[index].moduleList[index1].group_data[index3].goods_list, index2, dd2)
      self.$set(self.content.list[index].moduleList[index1].group_data[index3].goods_list, (index2 + 1), dd1)
    ...
    downImg3(index, index1,index2,index3) {
      console.log(index, index1,index2,index3)
      const self = this
      if (index2 === (self.content.list[index].moduleList[index1].group_data[index3].image_data.length - 1)) {
        return
      }
      const obj = self.content.list[index].moduleList[index1].group_data[index3].image_data[index2]
      const obj1 = self.content.list[index].moduleList[index1].group_data[index3].image_data[index2 + 1]
      self.$set(self.content.list[index].moduleList[index1].group_data[index3].image_data, index2, obj1)
      self.$set(self.content.list[index].moduleList[index1].group_data[index3].image_data, (index2 + 1), obj)
    ...
    */
    ...
    upImg4(index, index1,index2,index3) {
      console.log(index, index1,index2,index3)
      if (index2 === 0) {
        return
      }
    ...
    upImg3(index, index1,index2,index3) {
      console.log(index, index1,index2,index3)
      if (index2 === 0) {
        return
      }
    ...
    sureSelect(item) {
      ...
      if(this.select_index2===""&&this.select_spindex2==="") {
        ...
        console.log(222222,this.select_spindex2,this.select_index2)
        if(this.select_index2!=="") {
          console.log(1,this.select_index2)
          if(this.select_index3==="") {
             console.log(4,this.select_index3)
            ...
            console.log(5,this.select_index3)
            self.content.list[this.select_index].moduleList[this.select_index1].group_data[this.select_index3].image_data[this.select_index2].param = item.item_id
            self.content.list[this.select_index].moduleList[this.select_index1].group_data[this.select_index3].image_data[this.select_index2].good_info = item

            self.content.list[this.select_index].moduleList[this.select_index1].group_data[this.select_index3].goods_list = []
            for (let i = 0; i < self.content.list[this.select_index].moduleList[this.select_index1].group_data[this.select_index3].image_data.length; i++) {
              self.content.list[this.select_index].moduleList[this.select_index1].group_data[this.select_index3].goods_list.push(self.content.list[this.select_index].moduleList[this.select_index1].group_data[this.select_index3].image_data[i].good_info.item_id)
            }
          }
          
        }
        if(this.select_spindex2!=="") {
          console.log(this.select_spindex2)
          if(this.select_spindex3==="") {
            console.log(3,this.select_index2)
            ...
            self.content.list[this.select_spindex].moduleList[this.select_spindex1].group_data[this.select_spindex3].floor_data[this.select_spindex2].param = item.item_id
            self.content.list[this.select_spindex].moduleList[this.select_spindex1].group_data[this.select_spindex3].floor_data[this.select_spindex2].good_info = item

            self.content.list[this.select_spindex].moduleList[this.select_spindex1].group_data[this.select_spindex3].goods_list = []
            for (let i = 0; i < self.content.list[this.select_spindex].moduleList[this.select_spindex1].group_data[this.select_spindex3].floor_data.length; i++) {
              self.content.list[this.select_spindex].moduleList[this.select_spindex1].group_data[this.select_spindex3].goods_list.push(self.content.list[this.select_spindex].moduleList[this.select_spindex1].group_data[this.select_spindex3].floor_data[i].good_info.item_id)
            }
          }
      ...
      if(this.select_index2===""&&this.select_spindex2==="") {
        ...
        if(this.select_index2!=="") {
          if(this.select_index3==="") {
            ...
            self.content.list[this.select_index].moduleList[this.select_index1].group_data[this.select_index3].image_data[this.select_index2].param = item.id
          }
        }
        if(this.select_spindex2!=="") {
          if(this.select_spindex3==="") {
            ...
            self.content.list[this.select_spindex].moduleList[this.select_spindex1].group_data[this.select_spindex3].floor_data[this.select_spindex2].param = item.id
          }
      ...
      if(this.select_index2===""&&this.select_spindex2==="") {
        ...
        if(this.select_index2!=="") {
          if(this.select_index3==="") {
            ...
            self.content.list[this.select_index].moduleList[this.select_index1].group_data[this.select_index3].image_data[this.select_index2].param = item.position_code
          }
        }
        if(this.select_spindex2!=="") {
          if(this.select_spindex3==="") {
            ...
            self.content.list[this.select_spindex].moduleList[this.select_spindex1].group_data[this.select_spindex3].floor_data[this.select_spindex2].param = item.position_code
          }
        }
      }
